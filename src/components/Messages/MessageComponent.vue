<template>
  <div
    ...
    v-click-outside="() => (isShowMessage = false)"
  ...
  >
    ...
    <message-tab v-show="isShowMessage"></message-tab>
  </div>
</template>

<script>
import MessageTab from "@/components/Messages/MessageTabComponent.vue";
import { ref } from "vue";
export default {
  components: { MessageTab },
  setup() {
